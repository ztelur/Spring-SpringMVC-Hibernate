...
!function (a) {
    ...
    b.DEFAULTS = {
        ...
        function A(a, c) {
            ...
            if (!b.opts.useClasses && !c) {
                ...
                for (e = 0; e < b.doc.styleSheets.length; e++) {
                    ...
                    if (j)for (var m = 0, n = j.length; n > m; m++)if (j[m].selectorText && j[m].style.cssText.length > 0) {
        ...
        function g(c) {
            ...
            if (d) {
                var e = d.previousSibling, f = d.nextSibling;
        ...
        function m(h) {
            ...
            if ((b.selection.isFull() && !b.opts.keepFormatOnDelete && !b.placeholder.isVisible() || l && b.placeholder.isVisible() && b.opts.keepFormatOnDelete) && (k || l)) {
                var m = b.html.defaultTag();
                if (m ? b.$el.html("<" + m + ">" + a.FE.MARKERS + "<br/></" + m + ">") : b.$el.html(a.FE.MARKERS + "<br/>"), b.selection.restore(),
                        !t(i))return h.preventDefault(), !0
            }
        ...
        var y, z, A, B = !1;
        return {_init: x, ctrlKey: r, isCharacter: t, isArrow: s, forceUndo: w, isIME: l}
        ...
        function B() {
            b.events.on("keydown", function (c) {
                var d = -1 != navigator.userAgent.indexOf("Mac OS X") ? c.metaKey : c.ctrlKey, e = c.which;
        ...
        function d(c, d) {
            var e = '<div class="fr-modal' + (b.opts.theme ? " " + b.opts.theme + "-theme" : "") + '"><div class="fr-modal-wrapper">', f = '<i title="' + b.language.translate("Cancel") + '" class="fa fa-times fr-modal-close"></i>';
        ...
        function h(a) {
            var c = l[a].$modal, d = c.data("instance") || b;
            d.events.enableBlur(), c.hide(), k.hide(), d.$doc.find("body").removeClass("prevent-scroll fr-mobile")
        }

        function i(a) {
            var c = l[a], d = c.$modal, e = c.$body, f = b.$win.height(), g = d.find(".fr-modal-wrapper"), h = g.outerHeight(!0), i = g.height() - (e.outerHeight(!0) - e.height()), j = f - h + i, k = e.get(0).scrollHeight, m = "auto";
            k > j && (m = j), e.height(m)
        }
        ...
        return {_init: j, get: c, create: e, show: g, hide: h, resize: i}
